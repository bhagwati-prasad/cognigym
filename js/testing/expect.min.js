...
const test = (test) => {
    if(!test.desc || !test.title) {
        console.log("Test 'title' and 'desc' are required.");
        return;
    }
    if(typeof test.test !== "function") {
        console.log("Test should have a function 'test'");
        return;
    }
    console.log("---------------------------------------------");
...
console.log(`To run test : test { title: 'abc', desc, 'abc', test: () => { ...test function }}`)